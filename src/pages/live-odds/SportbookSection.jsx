...
import { PinSvg, PinSvg2 } from './icons.jsx'
import { SPORTSBOOK_CATEGORIES, titleCase } from './shared.js'
import { PriorityTabs } from './shared.jsx'
...
// Markets after this index start collapsed unless the user has explicitly
// toggled them. Mirrors the original behavior — keep parity.
const DEFAULT_COLLAPSED_AFTER = 5

export function SportbookSection({
  markets,
  selectedCategory,
  onSelectCategory,
  active,
          ...
          {markets.map((market, i) => {
            ...
            const isCollapsed =
              collapsed[id] === undefined
                ? i > DEFAULT_COLLAPSED_AFTER
                : collapsed[id]
            const marketExposure =
              exposureByMarket?.get(String(market.marketId)) ?? null
